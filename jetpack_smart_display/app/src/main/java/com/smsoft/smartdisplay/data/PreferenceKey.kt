...
enum class PreferenceKey(val key: String, val title: Int) {
    ...
    PUSH_BUTTON_STATUS_TOPIC("pushButtonStatusTopic", R.string.push_button_status_topic),
    PUSH_BUTTON_COMMAND_TOPIC("pushButtonTopic", R.string.push_button_command_topic),
    ...
    ALARM_LIGHT_DIMMER_ENABLED("alarmLightDimmerEnabled", R.string.alarm_light_dimmer_enabled),
    ALARM_LIGHT_DIMMER_COMMAND_ON_OFF_TOPIC("alarmLightDimmerCommandOnOffTopic", R.string.alarm_light_dimmer_command_on_off_topic),
